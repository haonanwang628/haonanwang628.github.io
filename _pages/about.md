...
I'm a master student and to study at [Master of Science in Engineering in Computer Science (MSE)](https://www.cs.jhu.edu/academic-programs/graduate-studies/mse-programs/)from [Whiting School of Engineering](https://engineering.jhu.edu/), [Johns Hopkins University](https://www.jhu.edu/).
...
**b.	Large Language Model for RLHF:** I also try to study the use of *large language models*(LLMs) combined *Reinforcement Learning*(RL),and explore Reinforcement Learning with Human Feedback(RLHF) and their applications in the field of large language models.
