...
- <span style="color:red; font-weight: #FF0000;"> **1. Human-AI Alignment for Social NLP Subjective inductive coding**:</span> How to achieve the bidirectional Human-AI Alignment to bridge the socio-technical gap in building LLMs for an effective data annotation/collection pipeline and LLMs for mining/analysis more enriched information in NLP subjective data tasks.
